...
const EligibilityUK = () => {
  ...
  const faqData = [
    {
      question: "What are the academic requirements for UK universities?",
      answer: "For undergraduate programs, you need A-Levels, IB, or equivalent qualifications. For postgraduate programs, a good bachelor's degree is required. Specific requirements vary by university and program."
    },
    {
      question: "What English language tests are accepted for UK student visas?",
      answer: "IELTS, TOEFL, PTE Academic, and Cambridge English are accepted. Most universities require IELTS 6.0-7.0 overall, with no band less than 5.5-6.5. Some programs may require higher scores."
    },
    {
      question: "How much money do I need to show for my UK student visa?",
      answer: "You must show proof of funds covering tuition fees plus £1,334 per month for living expenses (for courses in London: £1,023 per month). This should be in liquid funds for at least 28 days."
    },
    {
    ...
    {
      question: "What is the Student Route visa?",
      answer: "The Student Route visa (formerly Tier 4) allows international students to study in the UK. It's valid for the duration of your course plus additional time, and allows limited work rights."
    },
    {
      question: "Are there scholarships available for international students?",
      answer: "Yes, there are various scholarships including Chevening Scholarships (UK government), Commonwealth Scholarships, university-specific scholarships, and country-specific awards."
    }
  ];
  ...
  return (
    <div className="eligibility-page">
      <div className="eligibility-header">
        <h1>Eligibility Criteria for the UK</h1>
        <p className="subtitle">Complete Guide to UK Student Visa Requirements</p>
      </div>

      <div className="eligibility-content">
        <div className="eligibility-section">
          <h2>Understanding UK Student Visa Requirements</h2>
          <p>The UK has specific requirements for international students to ensure they are genuine temporary entrants who will successfully complete their studies. Understanding these requirements is crucial for a successful visa application under the Student Route.</p>
          ...
          <div className="academic-requirements">
            ...
            <div className="academic-grid">
              <div className="academic-item">
                ...
                <ul>
                  <li>A-Levels, IB, or equivalent qualifications</li>
                  <li>IELTS 6.0-6.5 overall (5.5-6.0 in each band)</li>
                  <li>TOEFL 80-90 overall</li>
                  <li>PTE Academic 54-62 overall</li>
                </ul>
              </div>
              <div className="academic-item">
                ...
                <ul>
                  <li>Good bachelor's degree (2:1 or equivalent)</li>
          ...
          <div className="english-requirements">
            ...
            <div className="english-grid">
              ...
              <div className="english-item">
                ...
                <p>Independent institutions offering specialized courses and professional qualifications.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="financial-grid">
              <div className="financial-item">
                ...
                <ul>
                  ...
                  <li>Postgraduate: £18,000 - 40,000/year</li>
                  <li>Foundation courses: £10,000 - 20,000/year</li>
                  <li>English language courses: £5,000 - 15,000/year</li>
                </ul>
              </div>
              <div className="financial-item">
                ...
                <ul>
                  <li>London: £1,334/month (£16,008/year)</li>
                  <li>Outside London: £1,023/month (£12,276/year)</li>
                  <li>Accommodation: £500 - 1,200/month</li>
                  <li>Other expenses: £300 - 500/month</li>
                </ul>
              </div>
              <div className="financial-item">
                ...
                <ul>
                  <li>Personal savings (28+ days old)</li>
          ...
          <div className="visa-process">
            ...
            <div className="process-grid">
              <div className="process-item">
                ...
                <p>Apply to a UK university or college and receive Confirmation of Acceptance for Studies (CAS).</p>
              </div>
              <div className="process-item">
              ...
              <div className="process-item">
                ...
                <p>Complete the online Student Route visa application form and pay the visa fee.</p>
              </div>
              <div className="process-item">
          ...
          <div className="required-documents">
            ...
            <div className="documents-grid">
              ...
              <div className="documents-item">
                ...
                <ul>
                  <li>Bank statements (28+ days old)</li>
              ...
              <div className="documents-item">
                ...
                <ul>
                  ...
                  <li>CAS letter from institution</li>
        ...
        <div className="eligibility-section">
          ...
          <div className="faq-section">
            <h3>Common Questions About UK Student Visas</h3>
