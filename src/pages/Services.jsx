...
const services = [
  {
    ...
    content:
      "Personalized guidance to help you choose the right course, university, and country based on your academic background and career goals.",
  },
  {
    icon: (
      <svg
    ...
    content:
      "Expert support with university applications, documentation, and securing admissions to top institutions worldwide.",
  },
  {
    icon: (
      <svg
    ...
    title: "Visa Guidance",
    content:
      "Comprehensive visa counseling, document preparation, and interview training to maximize your chances of approval.",
  },
  {
    icon: (
      <svg
    ...
    content:
      "Coaching and resources for IELTS, TOEFL, PTE, and other language/entrance exams to help you achieve your target scores.",
  },
  {
    icon: (
      <svg
    ...
    content:
      "Information and assistance with scholarships, grants, and financial aid to make your education affordable.",
  },
  {
    icon: (
      <svg
    ...
    content:
      "Guidance on travel, accommodation, and settling in, so you are fully prepared for your new academic journey.",
  },
  {
    icon: (
      <svg
    ...
    content:
      "Ongoing support for students after arrival, including help with accommodation, local orientation, and more.",
  },
  {
    icon: (
      <svg
    ...
    content:
      "Assistance with travel arrangements, insurance, document attestation, and more to make your journey smooth.",
  },
];
